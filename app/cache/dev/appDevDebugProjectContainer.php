...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oc_platform.doctrine.candidature_notification' => 'getOcPlatform_Doctrine_CandidatureNotificationService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'symfony', 'user' => 'root', 'password' => 12345, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityListenerResolverService()
    {
        ...
        $instance->register($this->get('oc_platform.doctrine.candidature_notification'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_10f1026b61e912f982a66149c7f1530bf66484553841a0799db6c97780982015');
    ...
    /**
     * Gets the 'oc_platform.doctrine.candidature_notification' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOcPlatform_Doctrine_CandidatureNotificationService()
    {
        return $this->services['oc_platform.doctrine.candidature_notification'] = new \OC\PlatformBundle\DoctrineListener\ApplicationNotification($this->get('swiftmailer.mailer.default'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('585a723b9635a6.14799678')), true);
