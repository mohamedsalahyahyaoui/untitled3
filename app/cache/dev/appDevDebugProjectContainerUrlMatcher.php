...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'OC\\CoreBundle\\Controller\\CoreController::indexAction',  '_route' => 'oc_core_homepage',);
        }

        if (0 === strpos($pathinfo, '/platform')) {
            // oc_hello_world
            if ($pathinfo === '/platform/hello_world') {
                return array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::indexAction',  '_route' => 'oc_hello_world',);
            }
            ...
            // oc_platform_test_slug
            if ($pathinfo === '/platform/test_slug') {
                return array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::testSlugAction',  '_route' => 'oc_platform_test_slug',);
            }
